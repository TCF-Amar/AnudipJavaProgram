...
public class AttendanceServices {
    ...
    public void takeAttendanceForCourse() {
        ...
        for (Student student : students) {
            System.out.print("Mark attendance for " + student.getName() + " (P/A): ");
    ...
    public void getAttendanceByStudentId() {
        ...
        if (records.isEmpty()) {
            ...
            for (Attandence att : records) {
                System.out.println(att.getStudent().getName()+"- " + att.getDate() + " - Course ID: " + att.getCourseId() + " - Status: " + att.getStatus());
            }
        }
    }
    ...
    public void viewAllAttendance() {
        ...
        if (records.isEmpty()) {
            ...
            for (Attandence att : records) {
                System.out.println(att.getStudent().getName() + " - Course ID: " + att.getCourseId() + " - Status: " + att.getStatus());
            }
        }
    }
}
