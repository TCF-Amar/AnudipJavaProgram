...
public class StudentService {
	...
	public void viewEnrolledCourses() {
		System.out.println("Enter Student ID to view enrolled courses:");
		int studentId = Integer.parseInt(sc.nextLine());
		...
		List<String> courseNames = studentDAO.getCourseNamesByStudentId(studentId);

		if (courseNames.isEmpty()) {
			System.out.println("📭 No enrolled courses found for " + student.getName());
		} else {
			System.out.println("📚 Enrolled courses for " + student.getName() + ":");
			courseNames.forEach(course -> System.out.println(" - " + course));
		}
	}
